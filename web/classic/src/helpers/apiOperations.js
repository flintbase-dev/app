...
export const API_OPERATION_TYPES = Object.freeze({
  ...
  createTeamApiKey: 'mutation',
  updateTeamApiKey: 'mutation',
  deleteTeamApiKey: 'mutation',
  deleteTeamApiKeys: 'mutation',
  ...
  searchTeams: 'query',
  adminTeam: 'query',
  adminUpdateTeam: 'mutation',
  adminDeactivateTeam: 'mutation',
