...
var graphqlAPIOperations = []apiOperation{
	...
	apiQuery("teamBillingSummary", controller.GetTeamBillingSummary, teamMemberAuth(), withResourceParams("team_id")),
	apiQuery("teamTopups", controller.GetTeamTopups, teamAdminAuth(), withResourceParams("team_id")),
	apiQuery("teamApiKeys", controller.GetTeamTokens, teamMemberAuth(), withResourceParams("team_id")),
	apiQuery("teamApiKey", controller.GetTeamToken, teamMemberAuth(), withResourceParams("team_id", "id")),
	...
	apiMutation("createTeamApiKey", controller.CreateTeamToken, teamMemberAuth(), withResourceParams("team_id")),
	apiMutation("updateTeamApiKey", controller.UpdateTeamToken, teamMemberAuth(), withResourceParams("team_id")),
	apiMutation("deleteTeamApiKey", controller.DeleteTeamToken, teamMemberAuth(), withResourceParams("team_id", "id")),
	apiMutation("deleteTeamApiKeys", controller.DeleteTeamTokens, teamMemberAuth(), withResourceParams("team_id")),
	...
	apiQuery("apiKeys", controller.GetAllTokens, userActivity("api_key")),
	apiQuery("searchApiKeys", controller.SearchTokens, userActivity("api_key"), searchRateLimit()),
	apiQuery("apiKey", controller.GetToken, userActivity("api_key"), withResourceParams("id")),
	apiMutation("createApiKey", controller.AddToken, userActivity("api_key")),
	apiMutation("updateApiKey", controller.UpdateToken, userActivity("api_key")),
	apiMutation("deleteApiKey", controller.DeleteToken, userActivity("api_key"), withResourceParams("id")),
	apiMutation("deleteApiKeys", controller.DeleteTokenBatch, userActivity("api_key")),
