...
| 模型价格（每 Mtk） | Цена модели за Mtk | Model Price (per Mtk) | Цена ввода за миллион токенов |
| 模型补全价格（每 Mtk） | Цена вывода за Mtk | Completion Price (per Mtk) | Цена вывода за миллион токенов |
