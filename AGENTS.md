...
- Write any backward compatibility code, this app will only be fresh deployed

## DO

- For any backward compatibility code(if the user asked you to write them), try to write them in the cmd/migrator service.
